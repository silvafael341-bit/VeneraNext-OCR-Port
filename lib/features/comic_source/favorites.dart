...
typedef FavoriteDataResolver = FavoriteData? Function(String key);

FavoriteDataResolver? _favoriteDataResolver;

void configureFavoriteDataResolver(FavoriteDataResolver? resolver) {
  _favoriteDataResolver = resolver;
}
